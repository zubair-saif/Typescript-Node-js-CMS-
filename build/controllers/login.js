 ...
 * signin User
 */
exports.sigIn = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, validPassword, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_1 = _a.sent();
                res.json({ message: "Something Went Wrong" + err_1 });
                return [3 /*break*/, 4];
